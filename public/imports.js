...
var wasmBinaryFile = 'imports.wasm';
...
function jsMain(n){ console.log("number is ",n); }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__unlock": ___unlock, "emscripten_async_run_script": _emscripten_async_run_script, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_run_script": _emscripten_run_script, "emscripten_run_script_int": _emscripten_run_script_int, "emscripten_run_script_string": _emscripten_run_script_string, "fd_write": _fd_write, "jsMain": jsMain, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
Module["asm"] = asm;
...
var ___em_js__jsMain = Module["___em_js__jsMain"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__jsMain"].apply(null, arguments)
};
